...
Texto1 = "Bienvenido/a al juego de memoria.";
Texto2 = "No te dire donde estas, solo que jugar.";
Texto3 = "Tienes que completar las parejas sin perder tus 5 vidas.";
Texto4 = "Adelante, buena suerte.";
Texto5 = "O no...";
...
setTimeout(function(){
    ...
    Mensaje.innerText = Texto1;
},50);
setTimeout(function(){
    Mensaje.style.opacity = 0;
    setTimeout(function(){
        Mensaje.style.opacity = 1;
        Mensaje.innerText = Texto2;
    },1000);
},4000);
setTimeout(function(){
    Mensaje.style.opacity = 0;
